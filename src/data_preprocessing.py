...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            logger.info("stating our Data processing step")
            logger.info("Droping the unimportant columns")
    ...
    def balance_data(self,df):
        try:
            ...
            raise CustomException("Error failed to balance the data",e)
    ...
    def select_features(self, df):
        try:
            ...
            raise CustomException("Error failed to select the features",e)
