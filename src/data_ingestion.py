...
class DataIngestion:
    def __init__(self, config):
        ...
        logger.info(f"Data ingestion is started with {self.bucket_name} and file is {self.bucket_file_name}")
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.info("CSV file is sucessfully downloaded ot {RAW_FILE_PATH}")
